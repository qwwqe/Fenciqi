...
public class NewDictionaryDialogFragment extends DialogFragment {
    public interface NewDictionaryDialogListener {
        public void onConfirmDictionaryCreation(DialogFragment dialog);
    }

    public ArrayList<String> mWords = new ArrayList<>();
    public ArrayList<Integer> mFreqs = new ArrayList<>();

    private NewDictionaryDialogListener mListener;
    private Uri mUri;
    ...
    public void onAttach(Context context) {
        ...
        mListener = (NewDictionaryDialogListener) context;
    }
        ...
        builder.setView(contentView)
                ...
                .setPositiveButton(R.string.confirm, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int id) {
                        mListener.onConfirmDictionaryCreation(NewDictionaryDialogFragment.this);
                    }
                })
